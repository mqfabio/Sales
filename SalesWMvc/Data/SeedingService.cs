...
using SalesWMvc.Models.Enums;

namespace SalesWMvc.Data
{
    public class SeedingService
    {
        private SalesWMvcContext _context;

        public SeedingService (SalesWMvcContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            if (_context.Department.Any() ||
                _context.Seller.Any() ||                    // prop any virifica se ha algo
